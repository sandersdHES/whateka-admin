...
export function activityToForm(a: Partial<Activity>): ActivityFormValues {
  ...
  return {
    ...
    is_whateka_certified: a.is_whateka_certified ?? false,
    date_label: a.date_label ?? '',
    date_start: a.date_start ?? '',
    date_end: a.date_end ?? '',
    recurrence_type: (a.recurrence_type ?? '') as ActivityFormValues['recurrence_type'],
    seasonal_months: a.seasonal_months ?? [],
    weekly_days: a.weekly_days ?? [],
    update_frequency: (a.update_frequency ?? '') as ActivityFormValues['update_frequency'],
    next_update_at: a.next_update_at ?? '',
    update_notes: a.update_notes ?? '',
  };
}
